...
class pipeline3:
	...
	def __init__(self, classes=dataset.ALPHABET_ALL, nb_epochs_ocr = 800, nb_epochs_cut_classifier=800, \
	 ...
	 path_cut_classifier="checkpoints/pipeline1", nb_filters1_cut=20, nb_filters2_cut=40, \
	 nb_filters1_ocr=20, nb_filters2_ocr=40, dense_layer_size1_ocr=250, dense_layer_size1_cut=150 ):
		...
		self._cut_classifier = pipeline1(classes=classes, nb_epochs=nb_epochs_cut_classifier, \
